...
export function CommandSurface({
  ...
  return (
    <div className="modal-backdrop-overlay" onClick={onClose}>
      <div
        className="command-surface animate-scale-in"
                ...
                {editingId === chat.id ? (
                  ...
                  <>
                    <div className="command-item-content">
                      ...
                      <span className="command-item-meta text-xs text-secondary" style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                        {chat.mode === 'focus' ? (
                          ...
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--agent-mode)' }}>
